            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="titulacao" class="col-md-4 col-form-label text-md-right">{{ __('Titulação') }}</label>

                            <div class="col-md-6">
                                <input id="titulacao" type="text" class="form-control{{ $errors->has('titulacao') ? ' is-invalid' : '' }}" name="titulacao" value="{{ old('titulacao') }}" required autofocus>
